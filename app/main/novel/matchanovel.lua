local matchascript = require "main.novel.matchascript"
local save = require "main.novel.save"
local settings = require "main.novel.settings"
local system = require "main.novel.engine.defold.system"
local messages = require "main.novel.engine.defold.messages"
local pronouns = require "main.novel.extensions.pronouns"
...
local function set_render_order()
	for k, v in pairs(render_order) do
		local extracted = string.match(v, "/(.*)")
...
function M.release_inputs()
	for k, v in pairs(input_order) do
		M.post(v, "release_input_focus", {})
	end
end
