...
function M.new(options)
	...
	new.letter_nodes = {}
	new.init = M.init
	new.set_node = M.set_node
	new.set_options = M.set_options
	new.change_typewriter = M.change_typewriter
	new.start = M.start
	new.set_instant_text = M.set_instant_text
	new.hide_instant_text = M.hide_instant_text
	new.next = M.next
	new.clear = M.clear
	new.reposition = M.reposition
	new.set_scale = M.set_scale
	new.redraw = M.redraw
	new.get_state = M.get_state
	new.zoom = M.zoom
